...
class TestUnifiedRadialMLPBackwardCompatibility:
    ...
    def test_different_batch_sizes(self, edge_degree_mlp, layer_radial_mlps, batch_size):
        ...
        # Check edge_degree
        expected_edge = edge_degree_mlp(x)
        torch.testing.assert_close(unified_outputs[0], expected_edge, rtol=1e-5, atol=1e-5)
