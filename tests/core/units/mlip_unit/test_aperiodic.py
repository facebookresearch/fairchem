...
def test_conserving_mole_aperiodic_on_pt(dtype,num_tol,rot_tol,conserving_mole_checkpoint,fake_puma_dataset):
    ...
    for sample_idx in range(5):
        ...
        predictor_v1 = MLIPPredictUnit(inference_checkpoint_path, device=device,overrides={"backbone":{"radius_pbc_version":1}})
        predictor_v1.model = predictor_v1.model.to(dtype)

        predictor_v2 = MLIPPredictUnit(inference_checkpoint_path, device=device,overrides={"backbone":{"radius_pbc_version":2}})
