...
.. py:class:: DDPMTLoss(loss_fn: torch.nn.Module, reduction: Literal['mean', 'sum', 'per_structure'] = 'mean', coefficient: float = 1.0)
   ...
   .. py:method:: sum(input, mult_mask, num_samples, loss, natoms)


   .. py:method:: _ddp_mean(num_samples, loss)


   .. py:method:: mean(input, mult_mask, num_samples, loss, natoms)


   .. py:method:: per_structure(input, mult_mask, num_samples, loss, natoms)


   .. py:method:: _reduction(input, mult_mask, loss, natoms)


   .. py:method:: forward(input: torch.Tensor, target: torch.Tensor, mult_mask: torch.Tensor, natoms: torch.Tensor)
