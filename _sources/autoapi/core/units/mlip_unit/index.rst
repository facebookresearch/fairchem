...
.. py:function:: load_predict_unit(path: str | pathlib.Path, inference_settings: fairchem.core.units.mlip_unit.api.inference.InferenceSettings | str = 'default', overrides: dict | None = None, device: Literal['cuda', 'cpu'] | None = None, atom_refs: dict | None = None, form_elem_refs: dict | None = None, workers: int = 1) -> fairchem.core.units.mlip_unit.predict.MLIPPredictUnit
   ...
   :param form_elem_refs: Optional dictionary of element reference energies for formation energy calculations.
