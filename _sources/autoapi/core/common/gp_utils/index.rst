...
.. autoapisummary::
   ...
   core.common.gp_utils.GatherFromModelParallelRegionSumGrad
...
.. autoapisummary::
   ...
   core.common.gp_utils.pad_tensor
   core.common.gp_utils.trim_tensor
   core.common.gp_utils._tensor_to_split_partitions
   core.common.gp_utils._split_tensor
   core.common.gp_utils._reduce
   core.common.gp_utils._split
   core.common.gp_utils._gather
   core.common.gp_utils._gather_with_padding
   core.common.gp_utils.copy_to_model_parallel_region
...
.. py:function:: _tensor_to_split_partitions(tensor: torch.Tensor, dim: int = -1)

.. py:function:: _split_tensor(tensor: torch.Tensor, dim: int = -1, contiguous_chunks: bool = False)
...
.. py:class:: GatherFromModelParallelRegionSumGrad(*args, **kwargs)
...
.. py:function:: gather_from_model_parallel_region_sum_grad(input: torch.Tensor, dim: int = -1) -> torch.Tensor
