...
.. autoapisummary::
   ...
   core.common.gp_utils.ScatterToModelParallelRegion
   core.common.gp_utils.GatherFromModelParallelRegionGradPadded
   core.common.gp_utils.GatherFromModelParallelRegionSumGradPadded
   core.common.gp_utils.ScaleBackwardGrad
...
.. autoapisummary::
   ...
   core.common.gp_utils.pad_input
   ...
   core.common.gp_utils.get_dp_rank
   core.common.gp_utils.get_gp_rank
   core.common.gp_utils.get_dp_world_size
   core.common.gp_utils.get_gp_world_size
   core.common.gp_utils.size_list_fn
   core.common.gp_utils.reduce_from_model_parallel_region
   core.common.gp_utils.scatter_to_model_parallel_region
   core.common.gp_utils.gather_from_model_parallel_region
   core.common.gp_utils.gather_from_model_parallel_region_sum_grad
   core.common.gp_utils.scale_backward_grad
...
.. py:function:: pad_input(input: torch.Tensor, padded_size: int)
...
.. py:function:: size_list_fn(size: int, parts: int) -> list[int]
...
.. py:function:: scatter_to_model_parallel_region(input: torch.Tensor) -> torch.Tensor
...
.. py:function:: gather_from_model_parallel_region(input: torch.Tensor, natoms: int) -> torch.Tensor

.. py:function:: gather_from_model_parallel_region_sum_grad(input: torch.Tensor, natoms: int) -> torch.Tensor

.. py:class:: GatherFromModelParallelRegionGradPadded(*args, **kwargs)
...
.. py:class:: GatherFromModelParallelRegionSumGradPadded(*args, **kwargs)
...
.. py:function:: scale_backward_grad(input: torch.Tensor) -> torch.Tensor

.. py:class:: ScaleBackwardGrad(*args, **kwargs)
