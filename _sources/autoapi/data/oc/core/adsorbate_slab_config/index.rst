...
.. py:function:: get_interstitial_distances(adsorbate_slab_config: ase.Atoms, overlap_tag: int = 2)
   ...
   :param overlap_tag: Tag to check overlap with
   :type overlap_tag: int

   :returns: True if there is atomic overlap, otherwise False
   :rtype: (bool)


.. py:function:: there_is_overlap(adsorbate_slab_config: ase.Atoms, overlap_tag: int = 2)
