...
# =============================================================================
# Module wrapper (optional)
# =============================================================================


class TritonGateActivation(torch.nn.Module):
    """Triton-accelerated GateActivation module.

    Parameters must match: lmax=2, mmax=2, m_prime=True, hidden_channels=128
    """
