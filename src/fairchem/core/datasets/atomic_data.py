...
class AtomicData:
    ...
    def from_ase(
        ...
        hl_gap = (
            torch.FloatTensor([atoms.info.get("homo_lumo")])
            if r_data_keys is not None and "homo_lumo" in r_data_keys
            else 0.0
        )
