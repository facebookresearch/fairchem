...
def radius_graph_pbc_v2(
    ...
    if max_internal_cell > 200:
        logging.warning(
            "radius graph pbc: The cell seems large, {data.cell}, are you using PBC with a large box instead of using PBC=False? Graph generation will be slower than it should be."
        )
        grid_resolution = (
