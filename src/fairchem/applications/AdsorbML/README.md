...
`AdsorbML` is an algorithm to calculating the minima adsorbate binding energy (adsorption energy) for a unique adsorbate+surface combination. All ML models are obtained from [`fairchem`](https://facebookresearch.github.io/fairchem//) to perform corresponding structure relaxations.
