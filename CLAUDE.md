...
Anytime we learn something that could be beneficial in future coding sessions, automatically add it to `fairchem-skills/protocols/meta_fairchem_dev/SKILL.md` in the "Learned Gotchas" section. Do NOT add to this file.
