...
```
**PyPI package coming soon!** Unfortunately some of our latest dependencies have made releases for the required versions
for fairchem-core V2. We are working on this to have a simple PyPI install soon!
